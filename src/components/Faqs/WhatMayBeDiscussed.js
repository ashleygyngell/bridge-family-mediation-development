    ...
    <>
      ...
      <body>
        <div className="columns  ">
          <div className="column is-mobile is-tablet pl-6 pr-6 ">
            <div className="title column mt-6 mr-6 ml-6 is-9-desktop is-12-tablet is-12-mobile ">
              What may be discussed?
            </div>

            <div className="column pt-5 pl-6 pr-6  is-10-desktop is-12-tablet is-12-mobile mediator-text">
              <div className=" ">
                <bl>
                  <li>
                  ...
                  <li>
                    How the children will share their time between their
                    parents, including holidays.
                  </li>
                  <li>
                    How much children will see of members of their extended
