                    ...
                    <div className="column is-8 pr-6 pl-5 ">
                      ...
                      <div className="mediator-text pt-5 pb-5 ">
                        <p>
                          ...
                          elit. Temporibus magni reiciendis distinctio vero nam
                          illo, aspernatur itaque eius animi corrupti quisquam
                          excepturi quae qui earum ad in tempora repellat ea
                          totam voluptates tenetur! Quas hic consequuntur, rem
                          inventore, quod minima consequatur ex voluptatibus
                          saepe aut mollitia totam, incidunt molestiae error
                          consectetur? Quidem nisi sed cumque maiores saepe quia
                          neque commodi rerum totam optio vel, eaque aut?
                          Nesciunt nobis, sit iste tempora quia adipisci quos,
                          error at, tenetur assumenda fugit debitis!
                        </p>
                      </div>
                    </div>
                  </div>
